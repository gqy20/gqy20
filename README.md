...
<tr>
<td align="center" width="50%" style="padding: 15px; border: 1px solid #30363d; border-radius: 6px; margin: 5px; background-color: #0d1117;"><h3><a href="https://github.com/gqy20/cc-insights" style="color: #58a6ff; text-decoration: none;">cc-insights</a></h3><p style="color: #8b949e; font-size: 14px; margin: 10px 0;">AI 驱动的 Claude Code 使用数据分析工具 - 可视化数据、发现模式、获取智能推荐</p><div style="margin: 10px 0;"><img src="https://skillicons.dev/icons?i=go" alt="Go" /></div><div style="margin: 10px 0;"><img src="https://img.shields.io/github/stars/gqy20/cc-insights?style=flat-square&logo=github" alt="Stars" /> <img src="https://img.shields.io/github/forks/gqy20/cc-insights?style=flat-square&logo=github" alt="Forks" /> <img src="https://img.shields.io/github/languages/top/gqy20/cc-insights?style=flat-square" alt="Language" /></div></td>
